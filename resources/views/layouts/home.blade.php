...
<body>
    <div class="globalWrapper">
        ...
        <div class="recommenedWrapper">
            <div class="container">
                @yield('content')
            </div>
        </div>
        <!-- recommenedWrapper -->
        @include('partials.howItWorkVideo')
    ...
    <script>
       $(document).ready(function() {
           $('div.heroWrapper').vide({
               'mp4': "{{ asset('assets/videos/bgVideo') }}",
               'webm': "{{ asset('assets/videos/bgVideo') }}",
               'ogv': "{{ asset('assets/videos/bgVideo') }}",
               'poster': "{{ asset('assets/images/placeholders/bgVideo') }}",
               }, {
               position: '50% 50%',
               posterType: "jpg",
               resizing: true
